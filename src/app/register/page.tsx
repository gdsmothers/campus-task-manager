...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-900 to-slate-900 flex flex-col">
      ...
      {/* ─── TOP LOGO BAR (LIKE LANDING PAGE) ───────────────────────────── */}
      <header className="w-full py-4 px-6 flex items-center">
        <Link href="/" className="flex items-center gap-2 group">
          <div className="h-9 w-9 rounded-2xl bg-white flex items-center justify-center text-[#235DFF] font-bold">
            CT
          </div>
          <div>
        ...
        <div className="w-full max-w-md rounded-3xl bg-white/95 shadow-2xl border border-purple-200/70 p-6 space-y-5">
          <div className="space-y-1">
            ...
            <p className="text-xs text-slate-500">
              Sign up to start organizing your assignments, priorities, and
              reminders.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mt-3">
            ...
            <div className="space-y-1">
              ...
              <input
                id="name"
                type="text"
                className="w-full rounded-xl border border-slate-200 px-3 py-2 text-sm bg-white/90 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-purple-400"
